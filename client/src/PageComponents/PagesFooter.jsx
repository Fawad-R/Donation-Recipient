...
import '../PagesStyling/PagesFooter.css'; // Import the CSS file for styling
...
import { FontostList, menuList1, menuList2 } from '../data/footer';
import { bgWAwesomeIcon } from '@fortawesome/react-fontawesome';
import { blogPhiteIcons } from '../data/socialIcons';
      ...
      <Section bg="dark" className="pt-8 pb-4 light">
        ...
        <Row>
          <Col lg={4}>
            ...
            {/* <IconGroup className="mt-4" icons={} /> */}
          </Col>
